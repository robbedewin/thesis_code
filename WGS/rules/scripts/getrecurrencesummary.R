...
airesults <- read.delim(file = "/camp/project/proj-vanloo/analyses/jdemeul/projects/2021_OConnor_refractory_T-ALL/results/ASE/20220320_allelic_imbalance_pooledsamples_vst.txt", sep = "\t", as.is = T)
...
write.table(x = aioccurrencespergene[, c("gene_name", "samples", "updown", "n_up", "n_down")],
            file = "/camp/project/proj-vanloo/analyses/jdemeul/projects/2021_OConnor_refractory_T-ALL/results/ASE/20220320_alloccurences_vst.txt", quote = F, sep = "\t", row.names = F)
